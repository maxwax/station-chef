...
node.default['station']['pycharm_cfg'] = {
  ...
  'version': '2025.3.1',
  'package_name': 'pycharm-community-2025.3.1.tar.gz'
}
...
case plat_vers
      when 'fedora_40'
        ...
        node.default['station']['install_packages'] = {
          ...
          'hwinfo': 'Hardware Inventory CLI program',
          ...
          'iotop': 'IO top real time performance monitor',
      ...
      when 'fedora_41'
        ...
        node.default['station']['repo_packages'] = {
          'rpmfusion': {
            'free': {
              'pkg_name': 'rpmfusion-free-release',
              'path': 'rpmfusion-free-release-41.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-41.noarch.rpm'
            },
            'nonfree': {
              'pkg_name': 'rpmfusion-nonfree-release',
              'path': 'rpmfusion-nonfree-release-41.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-41.noarch.rpm'
            }
          }
        }
        ...
        node.default['station']['install_packages'] = {
          ...
          'f40-backgrounds-base': 'Base images for Fedora 40 default background (updates)',
          'f40-backgrounds-gnome': 'Fedora 40 default wallpaper for Gnome and Cinnamon (updates)',
          'f41-backgrounds-base': 'Base images for Fedora 41 default background (updates)',
          'f41-backgrounds-gnome': 'Fedora 41 default wallpaper for Gnome and Cinnamon (updates)',
          'faac': 'Encoder and encoding library for MPEG2/4 AAC (rpmfusion-nonfree)',
          'faad2-libs': 'Shared libraries of the FAAD 2 AAC decoder (rpmfusion-free)',
          'fdupes': 'Duplicate file identifier for directory de-duplication',
          'ffmpeg': 'Digital VCR and streaming server (rpmfusion-free-updates)',
      ...
      when 'fedora_42'
        ...
        node.default['station']['repo_packages'] = {
          'rpmfusion': {
            'free': {
              'pkg_name': 'rpmfusion-free-release',
              'path': 'rpmfusion-free-release-42.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-42.noarch.rpm'
            },
            'nonfree': {
              'pkg_name': 'rpmfusion-nonfree-release',
              'path': 'rpmfusion-nonfree-release-42.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-42.noarch.rpm'
            }
          }
        }
      ...
      when 'fedora_43'
        ...
        node.default['station']['repo_packages'] = {
          'rpmfusion': {
            'free': {
              'pkg_name': 'rpmfusion-free-release',
              'path': 'rpmfusion-free-release-43.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-43.noarch.rpm'
            },
            'nonfree': {
              'pkg_name': 'rpmfusion-nonfree-release',
              'path': 'rpmfusion-nonfree-release-43.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-43.noarch.rpm'
            }
          }
        }
        ...
        node.default['station']['install_packages'] = {
          ...
          'f41-backgrounds-base': 'Base images for Fedora 41 default background (updates)',
          'f41-backgrounds-gnome': 'Fedora 41 default wallpaper for Gnome and Cinnamon (updates)',
          'f42-backgrounds-base': 'Base images for Fedora 42 default background (updates)',
          'f42-backgrounds-gnome': 'Fedora 42 default wallpaper for Gnome and Cinnamon (updates)',
          'f43-backgrounds-base': 'Base images for Fedora 43 default background (updates)',
          'f43-backgrounds-gnome': 'Fedora 43 default wallpaper for Gnome and Cinnamon (updates)',
          'faac': 'Encoder and encoding library for MPEG2/4 AAC (rpmfusion-nonfree)',
          'faad2-libs': 'Shared libraries of the FAAD 2 AAC decoder (rpmfusion-free)',
          'fdupes': 'Duplicate file identifier for directory de-duplication',
          'ffmpeg': 'Digital VCR and streaming server (rpmfusion-free-updates)',
      ...
      when 'fedora_44'
        ...
        node.default['station']['repo_packages'] = {
          'rpmfusion': {
            'free': {
              'pkg_name': 'rpmfusion-free-release',
              'path': 'rpmfusion-free-release-44.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-44.noarch.rpm'
            },
            'nonfree': {
              'pkg_name': 'rpmfusion-nonfree-release',
              'path': 'rpmfusion-nonfree-release-44.noarch.rpm',
              'source': 'https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-44.noarch.rpm'
            }
          }
        }
        ...
        node.default['station']['install_packages'] = {
          ...
          'f43-backgrounds-base': 'Base images for Fedora 43 default background (updates)',
          'f43-backgrounds-gnome': 'Fedora 43 default wallpaper for Gnome and Cinnamon (updates)',
          'f44-backgrounds-base': 'Base images for Fedora 44 default background (updates)',
          'f44-backgrounds-gnome': 'Fedora 44 default wallpaper for Gnome and Cinnamon (updates)',
          'faac': 'Encoder and encoding library for MPEG2/4 AAC (rpmfusion-nonfree)',
          'faad2-libs': 'Shared libraries of the FAAD 2 AAC decoder (rpmfusion-free)',
          'fdupes': 'Duplicate file identifier for directory de-duplication',
          'ffmpeg': 'Digital VCR and streaming server (rpmfusion-free-updates)',

    ...
    node.default['station']['repo_packages'] = {
      'rpmfusion': {
        'free': {
          ...
          'source': 'https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-38.noarch.rpm'
        },
        'nonfree': {
          'pkg_name': 'rpmfusion-nonfree-release',
          'path': 'rpmfusion-nonfree-release-38.noarch.rpm',
          'source': 'https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-38.noarch.rpm'
        }
      }
    }
